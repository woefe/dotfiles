...
--            * Wolfgang Popp <mail@wolfgang-popp.de>
...
function toggle(prog, vert, horiz, width, height, sticky, screen)
    ...
    if not dropdown[prog][screen] then
        spawnw = function (c)
            ...
            borders_width = beautiful.border_width * 2
            ...
            elseif horiz == "right" then x = screengeom.width - width - borders_width
            else   x =  screengeom.x + (screengeom.width - width - borders_width) / 2 end
