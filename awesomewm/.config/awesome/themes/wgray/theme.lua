...
theme_dir = os.getenv("HOME") .. "/.config/awesome/themes/wgray/"
theme = {}
theme.font          = "sans 8"

-- Default colors
theme.color = {}
theme.color.blue      = "#4aaef3"
theme.color.black     = "#000000"
theme.color.white     = "#FFFFFF"
theme.color.red       = "#e54d34"
...
theme.widget_graph_fg = "#f3f3f3"
theme.widget_text_fg = "#f3f3f3"

-- Common theme settings
theme.bg_normal     = "#b7b7b7"
theme.bg_focus      = "#efefef"
theme.bg_urgent     = theme.color.red
theme.bg_minimize   = "#b7b7b7"
